def select_books_titles_and_years_in_first_series_order_by_year
  "SELECT books.title, books.year FROM books WHERE books.year <= 2000 ORDER BY books.year;"
end
...
def select_series_title_with_most_human_characters
  "SELECT series.title FROM series JOIN characters ON characters.series_id = series.id WHERE species = 'human' GROUP BY characters.series_id ORDER BY COUNT(*) DESC LIMIT 1;"
end
